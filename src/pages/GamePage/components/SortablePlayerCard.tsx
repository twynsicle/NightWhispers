...
import dashboardStyles from './StorytellerDashboard.module.css'
import styles from './SortablePlayerCard.module.css'
...
export function SortablePlayerCard({
  ...
  return (
    <Card
      ...
      radius="md"
      withBorder
      className={!isDragging ? dashboardStyles.hoverCard : undefined}
      onClick={onClick}
    >
      <Group justify="space-between" mb="xs">
        <Group gap="sm">
          ...
          {player.avatar_id && (
            <Text size="xl" className={isDead ? styles.avatarDead : undefined}>
              {player.avatar_id}
            </Text>
          )}
