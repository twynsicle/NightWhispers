...
- MessageList.tsx exports MessageList component with messages prop
- MessageInput.tsx exports MessageInput component with onSendMessage prop
- MessageList uses ScrollArea with auto-scroll logic
- MessageInput uses Textarea with form submit handler
- Both components use gothic theme colors (crimson, dark.6)
  </verify>
  <done>
...
- Forget to filter broadcast messages in ConversationView when recipientId is null
...
- Status-driven rendering from Phase 3 pattern (lobby/active separation)
  ...
  <verify>
- TypeScript compiles without errors
- PlayerChatView.tsx exports PlayerChatView component
- StorytellerDashboard.tsx exports StorytellerDashboard component
- ConversationView.tsx exports ConversationView component
- RoomPage.tsx renders PlayerChatView for players when status is active
- RoomPage.tsx renders StorytellerDashboard for Storyteller when status is active
- StorytellerDashboard shows player cards with onClick handlers
- ConversationView has back button calling onBack prop
  </verify>
  <done>
