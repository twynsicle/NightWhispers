...
- **Drag-and-drop:** dnd-kit for player card reordering (SortablePlayerCard, useSortable hook)
- Mobile uses rectSortingStrategy (2D grid), desktop uses verticalListSortingStrategy (1D list)
- PointerSensor with 8px activation constraint prevents accidental drags
- KeyboardSensor for accessibility (arrow key navigation)
